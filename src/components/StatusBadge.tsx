...
import { PLMStatusStage, UserRole } from "../types";
import {
  getStatusDefinition,
...
const StatusBadge: React.FC<StatusBadgeProps> = ({
  ...
  const availableTransitions = getAvailableStatusTransitions(status, userRole);
  ...
  const handleStatusSelect = (newStatus: PLMStatusStage) => {
    if (
      canUserTransitionStatus(status, newStatus, userRole) &&
      onStatusChange
    ) {
